    ...
    const onSubmit = async(e) => {
        ...
        return (
           <div className="p-5 bg-white shadow w-fit mx-auto mt-4">
            ...
            <p className="text-center mt-2 opacity-50">Resume your adventure with Wanderlust</p>
            <Form
        ...
        >
          ...
          <div className="">
            ...
            <p className="text-center mt-4">Already have an account? <Link href={'/login'}>Sign Up</Link></p>
          </div>
        </Form>
           </div>
        );
